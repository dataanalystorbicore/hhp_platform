...
def update_database(pos_report):
    ...
    data_pos.columns = [
        "Region_name", "Wilaya", "Commune", "POSTCODE", "Cluster", "BBE (ORB)", "APP CREDENTIALS", "DISTRICT ID",
        "POS Stat", "Site ID", "Grade", "Pos Type", "Name", "PropriétaireFirstname", "PropriétaireLastname",
        "PropriétairePhone", "GérantFirstname", "GérantLastname", "GérantPhone", "Address", "Photo",
        "CHANNEL", "SUB-CHANNEL", "DATA TYPE", "TYPE DE PDV", "SITUATION GEOGRAPHIQUE",
        "Area", "Latitude", "Longitude", "Coverage", "Visit Day"
    ]
