...
def update_database(pos_report):
    ...
    if not missing_in_df.empty:
        ...
        df = df[['System ID', 'Create Time', 'Update Time', 'Delete Time', 'Last Visit','region_name',
        'Region', 'District', 'Territory', 'Code', 'Pos id', 'Status' ,'Site ID', 'Name', 'Wilaya',
        'Wilaya(48)', 'APP ID', 'BBE CODE', 'Pos Type','Commune', 'Address', 'Rooting', 'Coverage', 'Visit Day', 
        'Latitude', 'Longitude','Photo','PropriétaireFirstname','PropriétaireLastname', 'PropriétairePhone', 'GérantFirstname',
        'GérantLastname', 'GérantPhone', 'VendeurFirstname', 'VendeurLastname','VendeurPhone']]
